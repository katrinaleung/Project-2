...
plot(train$RBI ~ train$Hits, col='blue', xlab="train hits and walks", ylab="trainRBIs")
points(train$RBI ~ train$Walks, col='orange')
lines(x_grid, predictions, col='black', lwd=3)
points(test$RBI ~ test$Hits, col='red', pch=3)
...
plot(train$RBI ~ train$Runs, col='blue', ylim=c(0, 50))
lines(x_grid, predictions, col='black', lwd=3)
points(test$RBI ~ test$Runs, col='red', pch=3)
...
x_grid <- seq(0,81,.1) #CREATES GRID OF X-AXIS VALUES
plot(train$RBI ~ train$Hits, col='blue', xlab="train hits walks and runs", ylab="trainRBIs")
points(train$RBI ~ train$Walks, col='orange')
points(train$RBI ~ train$Runs, col='green', ylim=c(0, 50))
...
lines(x_grid, predictions_1, col='blue', lwd=3) 
lines(x_grid, predictions_2, col='yellow', lwd=3) 
